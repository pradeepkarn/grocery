    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                ...
                <form action="/<?php echo home; ?>/admin/all-customers/">
                <div class="d-flex">
                ...
                <div class="pagination">
                    ...
                    if ($enqs->filter_index(array('user_group'=>$user_group),$ord='',$limit = 999999,$change_order_by_col="id")!=false) {
                        ...
                        <?php $i=0; $page = 1; while($i < $nubenqs){ ?>
                            <a class="<?php if(isset($_GET['startfrom_numrows'])){ echo($_GET['startfrom_numrows']==$i.',5')?"active":""; } ?>" href="/<?php echo home; ?>/admin/all-customers/?startfrom_numrows=<?php echo $i; ?>,5"><?php echo $page; ?></a>
                        <?php  $i+=5; $page++; } ?>
                    <?php  }
                    ?>
        ...
        <div class="col-md-12">
            ...
            if (isset($_GET['user_serch_keywords'])) {
                ...
                $users = $usrObj->search($srcharr, $ord='DESC',$limit =10,$change_order_by_col="id",array('user_group'=>'customer'));
            } 
