...
<section>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="pagination">
                    ...
                    if ($enqs->filter_index(array('user_group'=>'salesman'),$ord='',$limit = 999999,$change_order_by_col="id")!=false) {
                        $nubenqs = count($enqs->filter_index(array('user_group'=>'salesman'),$ord='',$limit = 999999,$change_order_by_col="id")); ?>
        ...
        //     return;
            ...
            $users = $usrObj->filter_index(array('user_group'=>'salesman'),$ord='DESC',$limit,"id");
