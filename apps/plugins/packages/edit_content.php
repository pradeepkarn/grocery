        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <input type="hidden" onkeyup="createSlug('page_slug_edit', 'page_slug_edit');" id="page_slug_edit" name="slug" class="form-control mb-2 update_page" value="<?php echo $page['slug']; ?>">
                    <h5>Price</h5>
                ...
                <!-- <a data-bs-toggle="modal" data-bs-target="#GalleryModel">Add Image</a> -->
                    ...
                    <div style="max-height: 250px; overflow-y: scroll;">
                          ...
                          <?php pkAjax("#delete-this-detail{$fvl['id']}","/admin/packages/delete-content-details",".delete-data-detail{$fvl['id']}","#res-delt"); ?>
                          <?php endforeach;  ?>
                   
                  </div>
                  <form action="/<?php echo home; ?>/admin/packages/add-more-detail" id="add-more-detail-form">
                  <!-- <div class="progress">
                ...
                <div class="col-md-4">
                    ...
                    <form action="/<?php echo home; ?>/page/edit/<?php echo $page['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input class="hide" type="file" name="banner" class="form-control mb-2">
                    ...
                    <div style="max-height: 100px; overflow-y: scroll;">
                            <ul class="list-none">
                                    ...
                                    <?php pkAjax("#delete-this-img{$fvl['id']}","/admin/packages/delete-content-details",".delete-data{$fvl['id']}","#res-delt"); ?>
                                    <?php endforeach;  ?>
                                </ul>
                            </div>
                            <form action="/<?php echo home; ?>/admin/packages/add-more-img" id="add-more-img-form">
                            <div class="progress">
                                <div class="progress-bar"></div>
                            </div>
                            <input type="hidden" name="content_id" value="<?php echo $page['id']; ?>">
                            <input type="hidden" name="content_group" value="product_more_img">
                            <input type="file" name="add_more_img" class="form-control">
                            </form>
                   ...
                   <input id="post_cat_radio_select" type="radio" name="cat">
                    ...
                    <?php $dbcat = new Mydb('content');
                            $cts = $dbcat->filterDistinct($col="post_category", $ord='',$limit = 100);
    ...
    <script>
      $(document).ready(function() {
           $('#update_page_btn').click(function(event) {
              ...
              tinyMCE.triggerSave();
              $.ajax({
                  url: "/<?php echo home; ?>/admin/packages/edit/<?php echo $page['id']; ?>/update",
                  method: "post",
