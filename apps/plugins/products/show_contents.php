    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="my-4 d-flex justify-content-end">
                    <a class="btn btn-primary" href="/<?php echo home; ?>/admin/products/add-new-item"> <i class="fas fa-plus"></i> Add New Product </a>
            </div><?php 
            
            // $cart_jsn[] = array('pid'=>1,'qty'=>2);
            // $cart_jsn[] = array('pid'=>2,'qty'=>2);
            // $cart_jsn[] = array('pid'=>3,'qty'=>2);
            
            // $cart = json_encode($cart_jsn);
            // print_r($cart);
            ?>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td><a href="/<?php echo home; ?>/admin/products/edit/<?php echo $pv['id']; ?>">Edit</a></td>
                    ...
                    <div class="modal-dialog">
                        ...
                        <a class="btn btn-danger" href="/<?php echo home; ?>/admin/products/delete/<?php echo $pv['id']; ?>">Delete</a>
                        </div>
                        </div>
                    </div>
                    </div>
