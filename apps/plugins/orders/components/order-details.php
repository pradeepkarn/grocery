                  ...
                  <tr class="text-start">
                    ...
                    <tbody style="border: 1px dotted black;">
                        ...
                        <tr>
                            ...
                            <b>Change Salesman</b>
                            <select <?php if(!is_superuser()){echo "disabled";} ?> name="salesperson_id" class="form-select dlvdt<?php echo $cp['id']; ?>">
                            ...
                            <?php if(!is_superuser()){echo "<input type='hidden' name='salesperson_id' value='{$cpo[0]['salesperson_id']}'>";} ?>
                               <?php } ?>
