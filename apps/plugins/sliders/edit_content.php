                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="content_type" class="update_page form-control mb-2 mt-2">
                                <option <?php if($page['content_type'] == 'main'){ echo "selected"; } ?> value="main">Main</option>
                                <option <?php if($page['content_type'] == 'deals'){ echo "selected"; } ?> value="deals">Deals</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <h3>Status</h3>
                ...
                <!-- <a data-bs-toggle="modal" data-bs-target="#GalleryModel">Add Image</a> -->
                    ...
                    <input type="hidden" name="update_page" class="form-control mb-2 update_page" value="update_page">
                            ...
                            <div style="max-height: 250px; overflow-y: scroll;">
                                    ...
                                    <?php pkAjax("#delete-this-detail{$fvl['id']}","/admin/sliders/delete-content-details",".delete-data-detail{$fvl['id']}","#res-delt"); ?>
                                    <?php endforeach;  ?>
                             
                            </div>
                            <form action="/<?php echo home; ?>/admin/sliders/add-more-detail" id="add-more-detail-form">
                            <!-- <div class="progress">
