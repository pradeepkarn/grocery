    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="my-4 d-flex justify-content-end">
                    <a class="btn btn-primary" href="/<?php echo home; ?>/admin/portfolios/add-new-item"> <i class="fas fa-plus"></i> Add New Portfolio</a>
            </div>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td><a href="/<?php echo home; ?>/admin/portfolios/edit/<?php echo $pv['id']; ?>">Edit</a></td>
                    ...
                    <div class="modal-dialog">
                        ...
                        <a class="btn btn-danger" href="/<?php echo home; ?>/admin/portfolios/delete/<?php echo $pv['id']; ?>">Delete</a>
                        </div>
                        </div>
                    </div>
                    </div>
