                ...
                <!-- <a data-bs-toggle="modal" data-bs-target="#GalleryModel">Add Image</a> -->
                    ...
                    <input type="hidden" name="update_page" class="form-control mb-2 update_page" value="update_page">
                            ...
                            <div style="max-height: 250px; overflow-y: scroll;">
                                    ...
                                    <?php pkAjax("#delete-this-detail{$fvl['id']}","/admin/portfolios/delete-content-details",".delete-data-detail{$fvl['id']}","#res-delt"); ?>
                                    <?php endforeach;  ?>
                             
                            </div>
                            <form action="/<?php echo home; ?>/admin/portfolios/add-more-detail" id="add-more-detail-form">
                            <!-- <div class="progress">
                ...
                <a class="btn btn-dark mb-4" href="/<?php echo home; ?>/admin/<?php echo $plugin_dir; ?>">Back</a>
                    ...
                    <!-- Attribute  images -->
                            ...
                            <ul class="list-none">
                                    ...
                                    <?php pkAjax("#delete-this-img{$fvl['id']}","/admin/portfolios/delete-content-details",".delete-data{$fvl['id']}","#res-delt"); ?>
                                    <?php endforeach;  ?>
                                </ul>
                            </div>
                            <form action="/<?php echo home; ?>/admin/portfolios/add-more-img" id="add-more-img-form">
                            <div class="progress">
                                <div class="progress-bar"></div>
                            </div>
                            <input type="hidden" name="content_id" value="<?php echo $page['id']; ?>">
    ...
    <script>
      $(document).ready(function() {
           $('#update_page_btn').click(function(event) {
              ...
              tinyMCE.triggerSave();
              $.ajax({
                  url: "/<?php echo home; ?>/admin/portfolios/edit/<?php echo $page['id']; ?>/update",
                  method: "post",
