           ...
           <!-- Billing details -->
            <div class="row">
                ...
                <div class="form-floating">
                    <input type="text" id="fName" name="first_name" value="<?php echo $user!=false?$user['first_name']:""; ?>" class="form-control cart-info">
                    <label for="fName">First Name *</label>
                    </div>
                </div>
                <div class="col-md-6 my-2">
                <div class="form-floating">
                    <input type="text" id="lName" name="last_name" value="<?php echo $user!=false?$user['last_name']:""; ?>" class="form-control cart-info">
                    <label for="lName">Last Name *</label>
                    </div>
                </div>
                <div class="col-12 my-2">
                    <div class="form-floating">
                    <textarea name="my_location" class="form-control cart-info" id="myLocation" style="min-height: 100px"><?php echo $user!=false?$user['address']:""; ?></textarea>
                    <label for="myLocation">Address/Location/Landmark</label>
                    </div>
                </div>
                    <?php 
                ...
                <script>
                    var exists = false;
                    $('#cntrName option').each(function(){
                        if (this.value == '<?php echo $user!=false?$user['country']:""; ?>') {
                            // exists = true;
                            // return false;
                            $("#cntrName").val("<?php echo $user!=false?$user['country']:""; ?>");
                        }
                    });
                </script>
                <div class="col-md-6 my-2">
                <div class="form-floating">
                    <input type="text" id="stateName" name="state_name" value="<?php echo $user!=false?$user['state']:""; ?>" class="form-control cart-info">
                    <label for="stateName">Sate/County *</label>
                    </div>
                </div>
                <div class="col-md-6 my-2">
                <div class="form-floating">
                    <input type="text" id="cityName" value="<?php echo $user!=false?$user['city']:""; ?>" name="city_name" class="form-control cart-info">
                    <label for="cityName">Town/City *</label>
                    </div>
                </div>
                <div class="col-md-12 my-2">
                <div class="form-floating">
                    <input type="email" id="emailId" name="customer_email" value="<?php echo $user!=false?$user['email']:""; ?>" class="form-control cart-info">
                ...
                <div class="row">
                    <div class="col-md-6 my-2">
                        <div class="form-floating">
                            <input type="password" id="pass" name="pass" class="form-control cart-info">
                            <label for="pass">Password</label>
                        </div>
                    </div>
                    <div class="col-md-6 my-2">
                        <div class="form-floating">
                            <input type="password" id="pass" name="cnf_pass" class="form-control cart-info">
                ...
                <select name="isd_code" class="form-select cart-info" id="dialCode" aria-label="Floating label select example">
                    ...
                    <script>
                    var exists = false;
                    $('#dialCode option').each(function(){
                        if (this.value == '<?php echo $user!=false?$user['isd_code']:""; ?>') {
                            // exists = true;
                            // return false;
                            $("#dialCode").val("<?php echo $user!=false?$user['isd_code']:""; ?>");
                        }
                    });
                </script>
                </div>
                ...
                <div class="form-floating">
                    <input type="number" id="phoneNumber" name="mobile_number" value="<?php echo $user!=false?$user['mobile']:""; ?>" class="form-control cart-info">
                    <label for="phoneNumber">Phone (without 0 or +) *</label>
                    </div>
                </div>
                <div class="col-md-6 my-2">
                <div class="form-floating">
                    <input type="text" id="zipCode" name="zip_code" value="<?php echo $user!=false?$user['zipcode']:''; ?>" class="form-control cart-info">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td colspan="2">
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-lg <?php echo $user!=false?"btn-success":"custom-btn-bg text-white"; ?> update-cart-icon" id="place_order_btn" type="button">
                                        <?php
                                        if ($user==false) {
                                            echo "Signup and place order";
                                        }
                                        else{
                                            echo "Place Order";
                                        }
