<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo home; ?>/mark-attendance">
              <i class="mdi mdi-checkbox-marked-outline"></i>
              <span class="menu-title ms-3">Mark attendance</span>
            </a>
          </li>
          <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse show" id="leave">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="/<?php echo home; ?>/leaves/?leave_group=cl">Casual Leave</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/<?php echo home; ?>/leaves/?leave_group=pl">Paid Leave</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/<?php echo home; ?>/leaves/?leave_group=sl">Sick Leave</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/<?php echo home; ?>/leaves/?leave_group=ul">Unpaid Leave</a>
                </li>
              </ul>
            </div>
          </li>
