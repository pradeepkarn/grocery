                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="/<?php echo MEDIA_URL; ?>/img/faces/face2.jpg" class="me-2" alt="image" /> Jacob Jensen 
                            </td> 
                             <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/<?php echo MEDIA_URL; ?>/img/faces/face3.jpg" class="me-2" alt="image" /> Cecelia Bradley 
                            </td> 
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/<?php echo MEDIA_URL; ?>/img/faces/face4.jpg" class="me-2" alt="image" /> Leah Sherman 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/<?php echo MEDIA_URL; ?>/img/faces/face5.jpg" class="me-2" alt="image" /> Ina Curry 
                            </td> 
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                               <img src="/<?php echo MEDIA_URL; ?>/img/faces/face7.jpg" class="me-2" alt="image" /> Lida Fitzgerald 
                            </td> 
                             <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                               <img src="/<?php echo MEDIA_URL; ?>/img/faces/face2.jpg" class="me-2" alt="image" /> Stella Johnson 
                            </td>
                            <td>
                              <div class="d-flex">
                          ...
                          <tr>
                            <td>
                              <img src="/<?php echo MEDIA_URL; ?>/img/faces/face9.jpg" class="me-2" alt="image" /> Maria Ortiz 
                            </td>
                            <td>
                              <div class="d-flex">
                                <span class="pe-2 d-flex align-items-center">65%</span>
