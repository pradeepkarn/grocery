...
$db = new Dbobjects;
$prod = $db->showOne("SELECT p.id, p.bulk_qty, p.tax, p.qty_unit, p.price, p.discount_amt, p.title, p.banner, p.parent_id AS cat_id, (SELECT c.title FROM content c WHERE c.id = p.parent_id AND c.content_group = 'listing_category') AS cat_name, 
...
FROM content p WHERE p.id = '$pid' AND p.content_group = 'product' ORDER BY p.id DESC LIMIT 1");
// myprint($prod);
                            ...
                            <div class="row mb-50 mt-30">
                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="/<?php echo MEDIA_URL; ?>/images/pages/<?php echo $prod->banner; ?>" alt="product image" />
                                            </figure>
                                            <?php foreach ($moreimg as $key => $img) { 
                                                if ($img) {
                                                ?>
                                                <figure class="border-radius-10">
                                                    <img src="/<?php echo MEDIA_URL; ?>/images/pages/<?php echo $img; ?>" alt="product image" />
                                                </figure>
                                            <?php  } } ?>
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails">
                                            <div><img style="height: 100px; object-fit:cover;" src="/<?php echo MEDIA_URL; ?>/images/pages/<?php echo $prod->banner; ?>" alt="product image" /></div>
                                            <?php foreach ($moreimg as $key => $img) { 
                                                if ($img) {
                                                ?>
                                                <div><img style="height: 100px; object-fit:cover;" src="/<?php echo MEDIA_URL; ?>/images/pages/<?php echo $img; ?>" alt="product image" /></div>
                                            <?php  } } ?>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info pr-30 pl-30">
                                        ...
                                        <h2 class="title-detail"><?php echo $prod->title; ?></h2>
                                        <div class="product-detail-rating">
                                            <div class="product-rate-cover text-end">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
